...
--- Reduce the chance of Ziguranth patrols
function _M:ziguranthPatrolsReduce()
	self.ziguranth_patrols = 1
end

--- Get the chance of Ziguranth patrols
function _M:canZiguranthPatrol()
	return self.ziguranth_patrols
end
